...
select cats.name, shops.shopname from cats, shops
...
select shopname from shops
join cats
on shops.id = cats.shops_id and NOT cats.name="Murzik" AND NOT cats.name = "Zuza" ;
...
join Orders on Orders.ord_an = Analysis.an_id and 
(Orders.ord_datetime = "2020.02.05" or 
WEEK(Orders.ord_datetime, 1) = WEEK("2020.02.05", 1)+1);